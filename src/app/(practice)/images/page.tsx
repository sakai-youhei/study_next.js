    ...
    <>
      ...
      <Image src="/150x150.png" alt="Sample Image" width={150} height={150} />
        <div className='relative w-1/2 h-screen'>
          <Image src="/150x150.png" alt="Sample Image" sizes='50vw' fill style={{ objectFit: "cover" }} />
      </div>
       <div className='relative w-full lg:w-1/2 h-screen'>
        <Image src="/150x150-2.png" alt="Sample Image" fill style={{ objectFit: "cover" }} sizes='(max-width: 64rem) 50vw, 25vw' />
      </div>
